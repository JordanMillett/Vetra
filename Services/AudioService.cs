...
public class AudioService
{
    ...
    {   
        switch (Sound)
        {
            ...
            case Sounds.MicOn : if (Settings.Data.EnableMicSounds) { PlayCustom("mic-on.mp3"); } break;
            case Sounds.MicOff : if (Settings.Data.EnableMicSounds) { PlayCustom("mic-off.mp3"); } break;
        }
    }
